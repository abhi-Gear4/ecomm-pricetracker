...
class AmazonAPI:
    def __init__(self,search_item,filters,baseurl,currency):
    ...
    def run(self):
        ...
        print(f"Searching for {self.search_item} products")
...
if __name__ == '__main__':
    ...
    data = amazon.run()
    Generate_reports(NAME, FILTERS, BASE_URL, CURRENCY, data)
